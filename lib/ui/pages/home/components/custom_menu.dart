    ...
    return AnimatedOpacity(
      ...
      child: Visibility(
        ...
        child: _CustomMenuBackground(
          ...
          child: _MenuItems(items, activeColor, inactiveColor),
        ),
      ),
    );
  }
...
class _MenuItems extends StatelessWidget {
  const _MenuItems(this.menuItems, this.activeColor, this.inactiveColor);
...
//                                    size: (controller.itemSeleccionado.value == index) ? 35 : 25,
              Text(
                item.title,
                style: TextStyle(
                    fontSize: 11,
